...
<body>
      <%
            ...
            hardware=request.getParameter("dname");
            %>
       ...
       <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
           ...
           <li class="breadcrumb-item">
            <a href="user-specific-hardware-collage.jsp">Search Dashboard</a>
          </li>
          <li class="breadcrumb-item active">Specific Hardware Available in Collage</li>
        </ol>
                        ...
                        <h1 style="text-transform:capitalize">hardware Detail</h1><br>
                            ...
                            <table class="table-responsive-lg table-striped" style="width:100%" border="1px" cellpadding="10px">
                                 <thead>
                                  ...
                                  <%
             mylist1 = pd.specificHardCollege(hardware);
              for(Hardware H:mylist1)
                 {   
        %>
                                 <tbody>
                                   <tr>
                                       <td style="text-transform: uppercase"><%= H.getHdname()%></td>
                                     <td><%=H.getQuantity()%></td>
