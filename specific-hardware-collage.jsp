...
<div class="container-fluid">   
   ...
   <div class="card mb-3">
          <div class="card-body">
               <form action="show-hardware.jsp" method="post" class="">
                        <h1>Search Hardware</h1>
                          <div class="form-group">
                              <label for="id">Hardware Name</label>
                              <select class="form-control" id="id" name="dname" >
                                    <option value="available-hardware-collage.jsp">-Select-Please-</option>
