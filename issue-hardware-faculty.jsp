...
<title>Issue Hardware Faculty</title>
...
<div class="container-fluid">   
       <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Issue Hardware to Faculty</li>
        </ol>
   ...
   <div class="card mb-3">
          <div class="card-body">
                ...
                <form action="FacultySave.jsp" method="post" class="">
                         <div class="form-group">
                              <label for="hardwarename">Hardware Name</label>
                                <select class="form-control" id="hardware-name" name="hardwarename" >       
                         ...
                         <div class="form-group">
                              <label for="facultyname">Faculty Name</label>
                               <input type="text" class="form-control" id="faculty-name" name="facultyname" >                                       
                          </div>
                          <div class="form-group">
                              <label for="computercode">Computer Code</label>
                               <input type="number" class="form-control" id="computer-code" name="computercode" >                                       
                          </div>

                           <div class="form-group">
                              <label for="deptname">Department Name</label>

                               <select class="form-control" id="dept-name" name="deptname">   
                           ...
                           <div class="form-group">
                              <label for="cpu">Quantity</label>
                                  <input type="number" name="quantity" id="cpu" class="form-control">                            
                          </div>
