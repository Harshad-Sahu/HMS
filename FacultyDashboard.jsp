...
<div class="container-fluid">   
	  	  ...
	  	  <div class="col-xl-4 col-sm-6 mb-3">
	  	  	    <div class="card text-white bg-primary o-hidden h-100">
                   	 <div class="card-body">      
               			 ...
               			 <div class="mr-5 hd-text">Total Hardware Available <br> in a Collage</div>
              		 </div>
                 	 <a class="card-footer text-white clearfix small z-1" href="user-available-hardware-cllg.jsp">
	      ...
	      <div class="col-xl-4 col-sm-6 mb-3">
	  	  	    <div class="card text-white bg-info o-hidden h-100">
                   	 <div class="card-body">    
               			 ...
               			 <div class="mr-8 hd-text">Search Specific Hardware <br> in a Collage</div>
              		 </div>
                 	 <a class="card-footer text-white clearfix small z-1" href="user-specific-hardware-collage.jsp">
                     <span class="float-left bt-text">Click Here !</span> </a>
	  	        </div>
	     </div>
	      <div class="col-xl-4 col-sm-6 mb-3">
	  	  	    <div class="card text-white bg-danger o-hidden h-100">
                   	 <div class="card-body">  
                            ...
                            <i class="fas fa-fw fa-life-ring card-icon"></i>
                   	      ...
                   	      <div class="mr-8 hd-text">Issued Hardware Available <br> in Department</div>	
              		 </div>
                 	 <a class="card-footer text-white clearfix small z-1" href="user-issued-detail.jsp">
                     <span class="float-left bt-text">Click Here !</span> </a>
	  	        </div>
	     </div>
	     </div>
  ...
  <footer class="footer">
          <div class="copyright text-center">
            ...
            <p class="">Devs:&nbsp;&nbsp;&nbsp; Mohit Parmar &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Harshad Sahu &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Prashant Mehra</p>
          </div>
  </footer>
