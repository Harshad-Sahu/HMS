...
<title>Manipuate User Details</title>
...
%>
          ...
          <a class="dropdown-item" href="AccountInfo.jsp">Account</a>  s
...
<div class="container-fluid">   
       <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Manipulate User Details</li>
        </ol>
               ...
               <form action="" method="post" class="">
                        <h1>User Details</h1><br>
                            ...
                            <table class="table-responsive-lg table-striped" style="width:100%" border="1px" cellpadding="10px">
                                 ...
                                 <% 
                                 mylist=pd.manipulateShow();
                                 
                                  for(LoginModel LM1:mylist)
                                  {  
        %>
                                 <tbody>
                                 <tr>
                                    		           ...
                                    		           <td class="text-uppercase" ><%=LM1.getUsername()  %></td>  
                                                                     <td class="text-uppercase" ><%=LM1.getGender() %></td>  
                                                                    <td><%=LM1.getComputer_code() %></td>  
                                                                    <td><%=LM1.getAccount_type() %></td>  
                                                                     <td><%=LM1.getEmail() %></td>  
                                                                    <td><%=LM1.getDob() %></td> 
                                                                   <td class=""><a href="UpdateUserInfo.jsp?computer_code=<%= LM1.getComputer_code() %>">Update</a></td>
 	        	       	           <td class=""><a href="DeleteUser.jsp?computer_code=<%= LM1.getComputer_code() %>">Delete</a></td>
                                    		      </tr>
                                 </tbody>
