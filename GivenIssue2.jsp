...
<%!
    IssueHardware IH=new IssueHardware();
    List<IssueHardware> mylist1;
...
<title>Hardware Available</title>
...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    <a class="navbar-brand mr-1" href="FacultyDashboard.jsp">User Dashboard</a>
       ...
       <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
           ...
           <li class="breadcrumb-item">
            <a href="user-specific-hardware-dept.jsp">Departmental Detail</a>
          </li>
          <li class="breadcrumb-item active">Search Issued hardware in Department</li>
        </ol>
              ...
              <form action="" method="post" class="">
                        <h1 style="text-transform:capitalize">hardware Detail</h1><br>
                            ...
                            <table class="table-responsive-lg table-striped" style="width:100%" border="1px" cellpadding="10px">
                              ...
                              <%
             mylist1 = pd.viewIssue(department);
              for(IssueHardware IH:mylist1)
                 {   
        %>
                                 <tbody>
                  <tr>
                <td style="text-transform: uppercase"><%= IH.getHdname()%></td>  
                <td><%=IH.getQuantity()%></td>  
                <td style="text-transform: uppercase"><%=IH.getBrandname()%></td> 
                <td><%=IH.getManufacture()%></td> 
