      ...
      <div class="row">
	  	  <div class="col-xl-4 col-sm-6 mb-3">
	  	  	    <div class="card text-white bg-danger o-hidden h-100">
                   	 <div class="card-body"> 
                   	   <div class="card-body-icon card-icon">
                            <i class="fas fa-fw fa-users"></i>
                          </div>     
               			 <div class="mr-5 hd-text">Add New User<br><br></div>
              		 </div>
                 	 <a class="card-footer text-white clearfix small z-1" href="adduser.jsp">
	  	  	    ...
	  	  	    <div class="card text-white bg-success o-hidden h-100">
                   	 <div class="card-body">     
                   	  <div class="card-body-icon card-icon">
               			 ...
               			 <div class="mr-8 hd-text">Manipulate Details of User</div>
              		 </div>
                 	 <a class="card-footer text-white clearfix small z-1" href="manipulateuser.jsp">
                     <span class="float-left bt-text">Click Here !</span> </a>
	  	        </div>
	     </div>
