...
<div class="container-fluid">   
       <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Hardware Dashboard</li>
        </ol>
	  	  ...
	  	  <div class="col-xl-4 col-sm-6 mb-3">
	  	  	    <div class="card  text-white bg-primary o-hidden h-100">
                   	 <div class="card-body"> 
                             ...
                             <i class="fas fa-fw fa-life-ring card-icon"></i>
                           </div>        
               			 <div class="mr-5 hd-text">Add New Hardware in a Collage <br><br></div>
              		 </div>
                 	 <a class="card-footer text-white clearfix small z-1" href="addhardware.jsp">
                     <span class="float-left bt-text">Click Me !</span> </a>
	  	        </div>
	     </div>
	      <div class="col-xl-4 col-sm-6 mb-3">
	  	  	    <div class="card text-white bg-info o-hidden h-100">
                   	 <div class="card-body"> 
                   	   <div class="card-body-icon ">
               			 ...
               			 <div class="mr-8 hd-text">Total Hardware Available in a Collage</div>
              		 </div>
                 	 <a class="card-footer text-white clearfix small z-1" href="view-all-hardware-collage.jsp">
                     <span class="float-left bt-text">Click Me !</span> </a>
	  	        </div>
	     </div>
	      <div class="col-xl-4 col-sm-6 mb-3">
	  	  	    <div class="card text-white bg-danger o-hidden h-100">
                   	 <div class="card-body"> 
                   	    <div class="card-body-icon ">
                           <i class="fas fa-fw fa-shopping-cart card-icon"></i>
                        </div> 
                   	      <div class="mr-8 hd-text">Search For a Specific Hardware in a Collage</div>	
              		 </div>
                 	 <a class="card-footer text-white clearfix small z-1" href="specific-hardware-collage.jsp">
                     <span class="float-left bt-text">Click Me !</span> </a>
	  	        </div>
	     </div>
	</div>  
